...
def patchapk(source: str, architecture: str, gadget_version: str, pause: bool, skip_cleanup: bool,
             ...
             use_aapt2: bool, gadget_config: str, script_source: str, ignore_nativelibs: bool, manifest: str, skip_signing: bool, only_main_classes:bool = False, custom_gadget_name:str = None) -> None:
    """
